<?php
    ...
    $mail->Username = 'napriklad950@gmail.com';//SMTP username (email)
    $mail->Password = '';//SMTP password (email password)
    $mail->Port = '587';
    $mail->SMTPSecure = 'TLS';

    //From SMTP username (email)
    $mail->setFrom('napriklad950@gmail.com', 'Code Test');
    //To...
    $mail->addAddress('naprikladse9@gmail.com');
    //Subject
